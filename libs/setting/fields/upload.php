...
class CSFramework_Option_upload extends CSFramework_Options {
  ...
  public function output() {
    ...
    $button_title = ( isset( $button_title ) ) ? $button_title : __( '上传', 'cs-framework' );
    $frame_title  = ( isset( $frame_title  ) ) ? $frame_title  : __( '上传', 'cs-framework' );
    $insert_title = ( isset( $insert_title ) ) ? $insert_title : __( '插入图片', 'cs-framework' );
