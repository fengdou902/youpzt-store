...
;(function ( $, window, document, undefined ) {
  ...
  $(document).ready( function() {
    ...
    /*产品页面处理*/
    $( '.type_box' ).appendTo( '#youpzt_store_product_data .hndle span' );//添加meta_box到标题
    // Prevent inputs in meta box headings opening/closing contents
    $( '#woocommerce-product-data' ).find( '.hndle' ).unbind( 'click.postboxes' );
    //$( '#youpzt_store_product_data' ).toggleClass( 'closed' );
    jQuery( '#youpzt_store_product_data' ).on( 'click', '.hndle', function( event ) {
