...
if( ! function_exists( 'cs_admin_enqueue_scripts' ) ) {
  function cs_admin_enqueue_scripts() {
    global $pagenow;
    $theaction = isset($_GET['page']) ? $_GET['page'] : '';
    if( $pagenow=="edit-tags.php"||$pagenow=="post.php"||$pagenow=="post-new.php"||$pagenow=="edit-tags.php"||$pagenow=="profile.php"||$theaction=='youpzt_store_options') {
        // admin utilities
        wp_enqueue_media();
